// Karibische Häfen - Batch 2: Bridgetown, Fort-de-France, Pointe-à-Pitre,
// St. John's, Roseau, Castries.
// Externe Recherche mit vollständiger Abdeckung aller Kategorien.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-caribbean-batch2.ts
...
const dataPath = path.join(__dirname, "data", "port-research-caribbean-batch2.json");
