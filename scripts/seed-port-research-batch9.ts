// Neunte Charge: präzisierte Nachrecherche für 7 der in batch8 bereits
// geseedeten Häfen (Palma de Mallorca, Barcelona, Valencia, Cartagena
// (Spanien), Málaga, Ibiza, Marseille) - u. a. genauere Anleger-/
// Terminal-Angaben und ein paar 2026er Aktualisierungen (Kreuzfahrtgebühr
// Barcelona, Besucherbeschränkung Palma). Rohdaten in
// scripts/data/port-research-batch9.json. Struktur/Logik 1:1 aus
// seed-port-research-batch8.ts übernommen (nur die dort nötigen
// Namenskorrekturen entfallen hier, keiner der sieben Häfen betroffen).
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch9.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch9.json");
