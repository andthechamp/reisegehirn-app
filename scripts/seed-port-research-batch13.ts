// Dreizehnte Charge: Update/Refresh für Bridgetown (Barbados) mit aktualisierten Daten.
// Struktur/Logik 1:1 aus den vorherigen Batch-Skripten.
// Rohdaten in scripts/data/port-research-batch13.json.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch13.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch13.json");
