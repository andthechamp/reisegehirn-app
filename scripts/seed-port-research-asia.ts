// Asiatische Häfen: Phu My/Ho-Chi-Minh-Stadt, Chan May, Halong-Bucht, Hongkong, Busan.
// Externe Recherche mit vollständiger Abdeckung aller Kategorien.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-asia.ts
...
const dataPath = path.join(__dirname, "data", "port-research-asia.json");
