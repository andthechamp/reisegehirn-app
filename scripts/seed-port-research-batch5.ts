// Einmaliges Seed-Skript für eine fünfte Charge extern recherchierter
// Hafeninformationen (Persischer Golf: VAE, Katar, Oman, Bahrain), NICHT
...
// Rohdaten liegen in scripts/data/port-research-batch5.json - Struktur/Logik
// 1:1 aus seed-port-research-batch3.ts übernommen.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch5.ts
//
...
const dataPath = path.join(__dirname, "data", "port-research-batch5.json");
