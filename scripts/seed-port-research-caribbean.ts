// Karibische Häfen und US-Territorien: San Juan, Charlotte Amalie,
// Philipsburg, Basseterre, Nassau, Willemstad, Oranjestad.
// Externe Recherche mit vollständiger Abdeckung aller Kategorien:
// sehenswuerdigkeiten, anleger, ausflug_offiziell, ausflug_privat,
// zu_fuss, essen, praktisches.
//
// Struktur/Logik aus seed-port-research-batch8.ts übernommen.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-caribbean.ts
...
const dataPath = path.join(__dirname, "data", "port-research-caribbean.json");
