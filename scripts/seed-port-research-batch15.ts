// Fünfzehnte Charge: 6 Nahost-Häfen (Dubai, Abu Dhabi, Sir Bani Yas, Doha, Maskat,
// Khasab) – alle mit aktuellen Sicherheitswarnungen zum Persischen Golf (Feb/Aug 2026).
// Struktur/Logik 1:1 aus den vorherigen Batch-Skripten.
// Rohdaten in scripts/data/port-research-batch15.json.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch15.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch15.json");
