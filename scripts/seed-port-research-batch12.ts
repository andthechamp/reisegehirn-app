// Zwölfte Charge: 6 karibische Häfen (Bridgetown, Fort-de-France, Pointe-à-Pitre,
// St. John's, Roseau, Castries). Struktur/Logik 1:1 aus den vorherigen Batch-Skripten.
// Rohdaten in scripts/data/port-research-batch12.json.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch12.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch12.json");
