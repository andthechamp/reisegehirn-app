// Elfte Charge: 9 griechisch-türkische Häfen (Piräus/Athen, Santorin, Mykonos,
// Heraklion, Rhodos, Kusadasi/Ephesos, Istanbul). Struktur/Logik 1:1 aus den
// vorherigen Batch-Skripten. Rohdaten in scripts/data/port-research-batch11.json.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch11.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch11.json");
