// Einmaliges Seed-Skript für eine siebte Charge extern recherchierter
// Hafeninformationen (Japan & Südkorea), NICHT
...
// Rohdaten liegen in scripts/data/port-research-batch7.json - Struktur/Logik
// 1:1 aus seed-port-research-batch3.ts übernommen.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch7.ts
//
...
const dataPath = path.join(__dirname, "data", "port-research-batch7.json");
