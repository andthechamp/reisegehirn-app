// Zehnte Charge: 7 adriatisch-östliche Hafenanlauf-Informationen (Venedig, Triest,
// Dubrovnik, Split, Kotor, Korfu, Katakolon/Olympia). Struktur/Logik 1:1 aus
// seed-port-research-batch8.ts/batch9.ts. Rohdaten in
// scripts/data/port-research-batch10.json.
//
// Aufruf:
//   node --env-file=.env.local scripts/seed-port-research-batch10.ts
...
const dataPath = path.join(__dirname, "data", "port-research-batch10.json");
